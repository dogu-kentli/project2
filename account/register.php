...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['dogum'])) {
			$data['error_dogum'] = $this->error['dogum'];
		} else {
			$data['error_dogum'] = '';
		}
		...
		if (isset($this->request->post['dogum_tarihi'])) {
			$data['dogum_tarihi'] = $this->request->post['dogum_tarihi'];
		} else {
			$data['dogum_tarihi'] = '';
		}
	...
	private function validate() {
		...
		if (empty($this->request->post['dogum_tarihi'])) {
			$this->error['dogum'] = "Doğum tarihinizi giriniz.";
		}
